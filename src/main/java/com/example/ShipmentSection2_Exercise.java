...
//  ชื่อนักศึกษา :กรมภัฏ พิริยะ
//  รหัสนักศึกษา : 673380262-4
// ╚══════════════════════════════════════════════════════════╝
//
//  โจทย์:
...
class Shipment {
    ...
    public String toString() {
        return String.format("[%s]  %.2f กก. | %s |    %.2f บาท",trackingNumber,weightKg,type,calculateCost());
...
class ShippingCompany {
    ...
    public void printSummary() {
        ...
        System.out.println("----------------------------------------");
        // 2) แสดงยอดรวมตรงนี้
        System.out.printf("  ยอดรวมทั้งหมด : %.2f บาท",getTotalCost());
